...
VERBOSE                 = FALSE
'''
_gmt_defaults_by_version['4.2.0'] = _gmt_defaults_by_version['4.2.1']
_gmt_defaults_by_version['4.5.7'] = _gmt_defaults_by_version['4.5.2']
...
class GMT:
    ...
    def save(self, filename=None, bbox=None, raster_dpi=150, raster_antialias=True):
        ...
        if filename.endswith('.ppm'):
            ...
            subprocess.call([ 'epstopdf', '--res=300', '--outfile='+pdffilename, tempfn])
