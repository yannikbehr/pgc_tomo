...
def plot_rep(repfile,wtype,pixfile,show=True,misfit=0.1):
    """
...
if __name__ == '__main__':
    ...
    result = os.path.join(savedir,'reports/canada_52.000000_-75.000000.report')
    fout = os.path.join(savedir,'plots',os.path.basename(result).replace('.report','.eps'))
    misfit = 0.03
    wtype = 'rayleigh'
    plot_rep(result,wtype,fout,show=False,misfit='all')
    if 0:
